...
| **B** | [B-m5-import.md](B-m5-import.md)                 | 🟠 חסום (ע"י A)      | M5 — צינור-שאלות-NotebookLM (~500) — מחליף בנק-qa הישן (~540) · [ADR-015](../architecture/ADR-015-notebooklm-content-engine.md)        |
| **C** | [C-m6-deferred.md](C-m6-deferred.md)             | 🟡 פתוח (לא-חוסם)    | 3 ממצאי-M6 שנדחו + `server-only`                                                                                                       |
| **D** | [D-quiz-engine.md](D-quiz-engine.md)             | ⬜ פתוח              | Phase 5 — סימולציית-וועדה ([ADR-016](../architecture/ADR-016-committee-simulation.md)) · ExplanationCard · practice/exam · APIs · SM-2 |
