...
> מצב-על: 🔴 חוסם — הצעד-הבא · תלות: חוסם את M5 (B) · תלוי באישורי-מוטי · מעודכן: 2026-06-02.
...
- [ ] **A3 · פרויקט-גמר** — מוטי יעלה מצגת-הנחיות ממשרד-העבודה → עדכון [`FINAL-PROJECT.md`](../../courses/safety-officer/FINAL-PROJECT.md) לפרויקט אמיתי · קריטריון-קבלה: מצגת-ההנחיות התקבלה; שלב-6 (תיעוד-והגשה) ודרישות-הוועדה ב-FINAL-PROJECT עודכנו לפי הדרישות-הפורמליות (מבנה-מסמך · אורך · נספחים · קריטריוני-ציון); 3 ה-⬜ ב-§ TODO של המסמך נסגרו, כולל הכרעת-פרטיות על גיבוי פרויקט-הדוגמה (name-clean מוחלט, ללא PII/שם-אדם בתוצר-משתמש) · ref: [FINAL-PROJECT](../../courses/safety-officer/FINAL-PROJECT.md) · [ATTRIBUTION](../../courses/safety-officer/ATTRIBUTION.md) · [COMPLIANCE](../compliance/COMPLIANCE.md)
...
- **A2:** נוסחי-נבו הם "נוסח עדכני" (מאוחד) — לציטוט-מחייב לאמת מול רשומות/קובץ-התקנות (לאמת). שכבת רפורמות-2025 חסרה בנוסחים-הישנים — לא תוכן-קורס כעת (טריגר 10/2026).
- **A3:** מבנה-הליווי הנוכחי (6 שלבים) הוא placeholder עד המצגת — ייתכן שינוי-דרישות לאחר קבלתה (לאמת מול הנחיות-הוועדה המעודכנות).
