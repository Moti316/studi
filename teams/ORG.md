...
```
                        ┌─────────────────────────┐
                        │     מועצה (מוטי)         │  ← סמכות-על · אישור-סופי
                        │   Council / motilev8     │
                        └────────────┬────────────┘
                                     │  escalation / aggregate-report
                        ┌────────────┴────────────┐
                        │      מתווך — אמיר        │  ← ניתוב · הכרעת-קונפליקט · בקרת-סחף
                        │   mediator               │
                        └────────────┬────────────┘
              ┌──────────────┬───────┴───────┬──────────────┐
        ...
        strategic     builder          quality         coordinator
```

**עיקרון:** סוכן לעולם אינו מדבר ישירות עם המועצה. הזרימה היא תמיד
...
## רוסטר מלא — 27 הסוכנים

> 22 מבצעים + 4 ראשי-צוות + 1 מתווך = **27**.
> מודל: `opus` לחשיבה-עתירת-סיכון (strategic + ראשי-צוות + מתווך), `sonnet` לשאר.
