...
- לא מדלגת על `oversight-lead` (פרט לדגל-red-line קריטי). **[~~firewall~~ הוסר מהחריג — firewall-מגן בוטל 2026-06-09, ADR-009]**
...
- ~~הפרת-firewall/~~secret שדלף ולא דווח → דגל-חירום (`<<BROADCAST>>`) ל-`oversight-lead` → `council`. **[firewall-מגן בוטל 2026-06-09 — ADR-009; נותר רק דגל-secret]**
...
- מוקד קריטי לקראת 2026-07-15: דגל-red-line (תוכן-מומצא · secret · תלות-NotebookLM ~~· הפרת-firewall~~ **[firewall-מגן בוטל 2026-06-09 — ADR-009]**) שעלה אצל סוכן/ראש-צוות אך לא הגיע למועצה = הכשל-החמור-ביותר → המלצת-עצירה.
