...
- ✅ **#4 A1/A2 יישום** — תיקון-קורפוס (תקנה 65→עגורני-צריח תשכ"ז-1966 · 4 קבצים · 2.6.1 🔴→🟡) + מסמך-הכרעה [`A1-A2-RESEARCH-2026-06-11.md`](../../courses/safety-officer/A1-A2-RESEARCH-2026-06-11.md) (מיקום-ISO=רקע-מתודולוגיה). 🚩 דורש-מוטי: אישור-הורדת-נוסח + שיבוץ-ISO.
- 🔄 **#5 עיצוב-המשך B1 לכל-המסכים** (המשך-ב' 2026-06-11) — ✅ **נגן-שיעור** (`d8970e3`) · ✅ **★ מנגנון-תשובה נקי** (`ace6c37` · תיקן כפילות-משוב-התאמה · בקשת-מוטי) · ✅ **Capstone** stepper-hero (`8985c9a`) · ✅ **★ הגדרות — עיצוב + חיווט-כפתורים-מתים** (`fb9b9a6` · dark-mode אמיתי + localStorage · בקשת-מוטי). ⬜ נותר: סימולציה · קורס+חקיקה · Auth. [🧠 `studi-design-continuation-2026-06-11`]
- ⬜ **#6 בלוק-4 מורה-AI** — `TutorChat` + `tutor-explain.action` (reuse claude.ts author-model). **🚩 מוטי שאל עליו — פיצ'ר-נפרד מהעיצוב; הצעד-הבא המומלץ.**
...
1. 🔄 **A1 · ISO** — **מחקר+הכרעת-מיקום בוצעו (2026-06-11 · [A1-A2-RESEARCH](../../courses/safety-officer/A1-A2-RESEARCH-2026-06-11.md)):** מיקום = **רקע-תיאורטי בראש יחידת-המתודולוגיה** (לא נושא-עצמאי/נספח). 🚩 נותר: אישור-מוטי + שיבוץ `ISO-31010/31000-DRAFT` בפועל.
2. 🔄 **A2 · חקיקה** — **2.6.1 נפתר (2026-06-11):** עגורני-צריח = **תקנות עצמאיות תשכ"ז-1966** (תקנה 65 שם · לא 1992) → קורפוס-תוקן (4 קבצים · 🔴→🟡). 🚩 נותר: אישור-מוטי + הורדת נוסח-תשכ"ז-1966 מנבו → 🟢.
