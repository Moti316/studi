  ...
  return [
    {
      ...
      existingControls: { engineering: '', administrative: 'שילוט', ppe: '' },
      riskBefore: { severity: 4, probability: 3 },
      addedControls: {
        engineering: 'הפרדת-מסלולים פיזית (מחסומים)',
        administrative: 'נוהל-תנועה',
        ppe: 'אפוד-ניראות',
      },
    ...
    },
    {
      ...
      existingControls: { engineering: '', administrative: 'הדרכה', ppe: '' },
      riskBefore: { severity: 3, probability: 2 },
      addedControls: {
        engineering: 'מעצורי-מדף + עיגון-מדפים לרצפה',
        administrative: 'בדיקה-תקופתית',
        ppe: 'קסדה',
      },
      riskAfter: { severity: 3, probability: 1 },
      owner: 'ממונה-בטיחות',
      due: '',
      status: 'open',
    },
